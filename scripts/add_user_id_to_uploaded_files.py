#!/usr/bin/env python3
"""为uploaded_files表添加user_id字段的数据库迁移脚本

该脚本用于修复视频上传功能中缺少user_id字段的问题。
"""
...
def add_user_id_column():
    ...
    try:
        ...
        print("📝 正在创建索引...")
        cursor.execute("""
            CREATE INDEX IF NOT EXISTS ix_uploaded_files_user_id 
...
def main():
    """主函数"""
    print("🔧 开始为uploaded_files表添加user_id字段...")
    print("=" * 50)
